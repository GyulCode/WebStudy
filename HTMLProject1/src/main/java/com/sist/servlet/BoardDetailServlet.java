...
import com.sist.servlet.*;

/**
 * Servlet implementation class BoardDetailServlet
 */
@WebServlet("/BoardDetailServlet") //URL주소는 변경가능 @WebServlet 이부분과 맞춰줘야함
public class BoardDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<table border=1 backcolor=black width=700 class=table_content>");
		...
		out.print("<td colspan=3 align=center>"+vo.getSubject()+"</td>");
		out.print("</tr>");
